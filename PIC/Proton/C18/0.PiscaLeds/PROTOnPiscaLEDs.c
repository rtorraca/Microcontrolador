...
Descrição: Exemplo pisca LEDs da Placa (PA4 e PA5) alternadamente
		   e uso do BootLoader
...
#define PROGRAMMABLE_WITH_USB_HID_BOOTLOADER
   ...
   #pragma code
	...
	//
	// Abaixo os pontos de entrada realocados das interrupções
	//
	// Serviço/ Código de tratamento de Interrupções de **Alta prioridade**, ao acontecerem o programa vem pra cá
	...
	// Serviço/ Código de tratamento de Interrupções de **baixa prioridade**, ao acontecerem o programa vem pra cá
...
// Main - entrada programa
void main (void)
{
	Board_Init();		// inicia placa

	// coloca só um dos LEDs aceso pra alternar
	PORTAbits.RA5 = 1;
...
void Board_Init (void)
{
	...
	ADCON1 = 0x0F;		// CONFIGURA TODAS AS PORTAS ANALOGICAS COMO I/O menos A0 (sensor temp/trimpot)
